...
class SearchActivity: AppCompatActivity(){
    ...
    private fun initView() {
        ...
        for (fieldInForm in Repository.searchFormList) {
            ...
            val view: TextInputLayout = createView(this, Repository.CustomField(fieldInForm.name, fieldInForm.alias, fieldInForm.type))
    ...
    private fun initListeners() {
        searchButton.setOnClickListener {
            ...
            for (field in inputFields) {
                ...
                if (input != "") {
//                    println("${Repository.aliasCustomFieldMap[alias]?.name}-$alias: $input ${Repository.typesMap[Repository.aliasCustomFieldMap[alias]?.type]}")
//                    println(cleanString("${Repository.aliasCustomFieldMap[alias]?.name}"))
...
//            startIconDrawable = ContextCompat.getDrawable(context, R.drawable.ic_add)?.apply {
//                setTint(ContextCompat.getColor(context, R.color.black))
//            }
//            endIconMode = TextInputLayout.END_ICON_CUSTOM
//            endIconDrawable = ContextCompat.getDrawable(context, R.drawable.ic_search)?.apply {
//                setTint(ContextCompat.getColor(context, R.color.black))
//            }
//            setEndIconOnClickListener {
//                Snackbar.make(this, "end", Snackbar.LENGTH_SHORT).show()
//            }
//            setStartIconOnClickListener {
//                Snackbar.make(this, "start", Snackbar.LENGTH_SHORT).show()
//            }
